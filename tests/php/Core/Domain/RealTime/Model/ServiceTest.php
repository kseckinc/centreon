...
{
    /**
    * test description too long exception
    */
    public function testDescriptionTooLongException(): void
    {
        $description = str_repeat('.', Service::MAX_DESCRIPTION_LENGTH + 1);
        ...
        new Service(10, 1, $description, new ServiceStatus('OK', 0, 0));
    }

    /**
     * test description empty exception
     */
    public function testDescriptionEmptyException(): void
    {
        $description = '';
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage(
