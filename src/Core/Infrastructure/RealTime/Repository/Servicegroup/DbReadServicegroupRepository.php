...
class DbReadServicegroupRepository extends AbstractRepositoryDRB implements ReadServicegroupRepositoryInterface
{
    ...
    {
        return $this->findServicegroupsRequest($hostId, $serviceId);
    }
    ...
    public function findAllByHostIdAndServiceIdAndAccessGroupIds(
        ...
        return $this->findServicegroupsRequest($hostId, $serviceId, $aclRequest);
    }
     ...
     * @return Servicegroup[]
     */
    private function findServicegroupsRequest(int $hostId, int $serviceId, ?string $aclRequest = null): array
    {
